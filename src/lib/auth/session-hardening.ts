...
export class SessionHardening {
  ...
  public async createHardenedSession(
    userId: string,
    accessToken: string,
    refreshToken: string
  ...
  public async validateSession(
    ...
    try {
      ...
      if (
        currentFingerprint &&
        !this.validateFingerprint(session.fingerprint, currentFingerprint)
      ) {
        console.log(
          '❌ Fingerprint validation failed - potential session hijacking'
        )
  ...
  public async rotateSessionTokens(
    sessionId: string
  ...
  public async detectSuspiciousActivity(
    ...
    if (
      session.fingerprint.screenResolution !==
  ...
  private validateFingerprint(
    ...
    const nonCriticalMatchCount = nonCriticalMatches.filter(
      match => match
    ).length
  ...
  private async flagSuspiciousSession(
    sessionId: string,
    indicators: string[]
  ): Promise<void> {
...
// Convenience exports
export const createHardenedSession = (
  userId: string,
  accessToken: string,
  refreshToken: string
