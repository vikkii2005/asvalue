...
export const APP_CONFIG = {
  name: 'ASVALUE',
  description:
    'Turn your products into AI-powered sales machines with magic links',
  version: '1.0.0',
...
export const BUSINESS_RULES = {
  ...
  payout_threshold: 25.0, // Minimum payout amount
...
export const ERROR_MESSAGES = {
  ...
  CHAT_SESSION_EXPIRED:
    'Chat session has expired. Please start a new conversation.',
