  ...
  useEffect(() => {
    async function loadProfile() {
      ...
      try {
        ...
        // If error loading profile, show modal to be safe
          ...
          <div className="px-6 py-4">
            <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-3">
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900">{profileData?.business_name}</dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">Category</dt>
                <dd className="mt-1 text-sm text-gray-900">{profileData?.category}</dd>
              </div>
              <div>
