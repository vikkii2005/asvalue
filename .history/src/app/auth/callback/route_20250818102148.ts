...
// Fixed - Smart redirect logic (no more success page!)
...
export async function GET(request: NextRequest) {
  try {
    ...
    // *** SMART REDIRECT LOGIC - NO MORE SUCCESS PAGE! ***
    ...
    if (profile?.role) {
      ...
      if (profile.role === 'seller') {
        ...
        redirectUrl = '/marketplace'; // or '/dashboard/buyer'
      }
    ...
    // Create response with smart redirect
