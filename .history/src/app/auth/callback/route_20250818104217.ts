...
// FIXED - Simple reliable session system
...
export async function GET(request: NextRequest) {
  try {
    ...
    // *** REMOVED SESSION GENERATION - NOT NEEDED ***
    ...
    // *** NEW: SIMPLE RELIABLE SESSION SYSTEM ***
    ...
    // Set the single authentication cookie that both middleware and page can read
    response.headers.append('Set-Cookie', `asvalue-authenticated=${sessionValue}; Path=/; HttpOnly; SameSite=Lax; Max-Age=3600`);

    console.log('✅ Simple authentication cookie set successfully');
    return response;
