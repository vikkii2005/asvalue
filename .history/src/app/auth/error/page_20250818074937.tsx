...
export default function AuthErrorPage() {
  ...
  const [errorInfo, setErrorInfo] = useState<ErrorInfo>(errorMap.unexpected_error);
  ...
  const handleRetry = () => {
    ...
    console.log(`🔄 Auth error retry attempt #${retryCount + 1} for error: ${errorType}`);
        ...
        {retryCount > 0 && (
          <div style={{
            ...
            <p style={{
              ...
              Retry attempt #{retryCount}. If errors persist, please contact support.
            </p>
          </div>
        )}
