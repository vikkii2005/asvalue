...
// FIXED - Removed conflicting approval_prompt parameter
  ...
  useEffect(() => {
    async function initiateOAuth() {
      try {
        ...
        // ✅ FIXED: Removed conflicting parameters
        const params = new URLSearchParams({
          ...
          // ❌ REMOVED: approval_prompt (conflicts with prompt parameter)
          // ❌ REMOVED: login_hint (not needed)
          // ❌ REMOVED: hd (not needed)
        })
