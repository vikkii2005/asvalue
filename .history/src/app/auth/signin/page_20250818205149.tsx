...
// FIXED - Uses hardcoded redirect_uri to match token exchange
  ...
  useEffect(() => {
    async function initiateOAuth() {
      try {
        ...
        // 🔧 FIXED: Use EXACT same redirect_uri that server will use
        const redirectUri = 'https://asvalue.com/auth/callback';

        const params = new URLSearchParams({
          client_id: googleClientId,
          redirect_uri: redirectUri, // 🔧 FIXED: Hardcoded to match server
          response_type: 'code',
