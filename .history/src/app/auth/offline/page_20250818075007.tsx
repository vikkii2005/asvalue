...
export default function OfflinePage() {
  ...
  const handleGoOffline = () => {
    ...
    localStorage.setItem('asvalue_offline_auth', JSON.stringify({
      timestamp: Date.now(),
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '15px' }}>
            <strong style={{ color: '#374151', fontSize: '14px' }}>Connection Status:</strong>
            <span style={{ 
          ...
          <div style={{ marginBottom: '15px' }}>
            <strong style={{ color: '#374151', fontSize: '14px' }}>Last Checked:</strong>
          ...
          {retryAttempts > 0 && (
            <div>
              <strong style={{ color: '#374151', fontSize: '14px' }}>Retry Attempts:</strong>
              <span style={{ color: '#6b7280', fontSize: '14px', marginLeft: '10px' }}>
                {retryAttempts}
              </span>
            </div>
        ...
        {!isOnline && (
          <div style={{
            ...
            <ul style={{
              ...
              <li style={{ marginBottom: '5px' }}>Check your WiFi or mobile data</li>
              <li style={{ marginBottom: '5px' }}>Try switching between WiFi and mobile data</li>
              <li style={{ marginBottom: '5px' }}>Move closer to your WiFi router</li>
              <li style={{ marginBottom: '5px' }}>Restart your router if needed</li>
            </ul>
          </div>
        )}
