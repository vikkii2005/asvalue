  ...
  public: {
    Tables: {
      ...
      notifications: {
        ...
        Insert: Omit<OrderNotification, 'id' | 'created_at' | 'is_read'>
        Update: Partial<
          Omit<OrderNotification, 'id' | 'created_at' | 'seller_id'>
        >
      }
    }
  }
...
export const db = {
  ...
  chat: {
    ...
    async markAsRead(session_id: string, seller_id: string) {
    ...
    subscribeToSellerNotifications(
      ...
      return supabase
        ...
        .on(
          ...
          payload => callback(payload.new as OrderNotification)
        )
        .subscribe()
    },
