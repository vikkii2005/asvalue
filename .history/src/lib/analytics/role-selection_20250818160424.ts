...
// GOOGLE ANALYTICS 4 Implementation - ESLint Fixed
...
export const trackRolePageLoad = (userId: string, sessionId: string, socialProofDisplayed: Record<string, unknown>): void => {
...
export const trackSocialProofView = (role: string, count: number, message: string): void => {
  if (typeof window !== 'undefined' && window.gtag) {
...
// Track role hover
export const trackRoleHover = (role: string, duration: number, userId: string): void => {
  if (typeof window !== 'undefined' && window.gtag) {
...
export const trackHelpSectionOpen = (section: string, userId: string): void => {
  if (typeof window !== 'undefined' && window.gtag) {
...
export const trackUserHesitation = (duration: number, userId: string): void => {
  if (typeof window !== 'undefined' && window.gtag) {
