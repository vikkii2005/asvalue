...
export class CryptoUtils {
  static generateRandomBytes(length: number): Uint8Array {
    if (typeof crypto === 'undefined') throw new Error('Web Crypto API not available');
  ...
  static async validateCodeChallenge(verifier: string, challenge: string): Promise<boolean> {
    try {
