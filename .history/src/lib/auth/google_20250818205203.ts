...
// FIXED - Uses EXACT same hardcoded redirect_uri
...
export async function exchangeCodeForTokens(
  ...
  try {
    ...
    // 🔧 FIXED: Use EXACT same redirect_uri as browser request
    ...
    const params = new URLSearchParams({
      ...
      redirect_uri: redirectUri, // 🔧 FIXED: Hardcoded to match browser
    })
