...
// Authentic social proof component with progressive messaging
...
const getAuthenticMessage = (role: UserRole, stats: SocialProofData): string => {
  const { seller_count, buyer_count, days_live } = stats;
...
export default function AuthenticSocialProof({ role, stats, className = "" }: AuthenticSocialProofProps) {
