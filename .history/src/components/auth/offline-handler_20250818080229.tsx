...
export default function OfflineHandler({
  ...
  const processQueuedActions = useCallback(async () => {
    ...
    for (const action of queuedActions) {
      ...
      } catch (_error) { // ✅ FIXED: Removed unused error variable
  ...
  useEffect(() => {
    (window as Window & typeof globalThis & { queueOfflineAction?: typeof queueAction }).queueOfflineAction = queueAction;
    return () => {
