...
import { ArrowRight, Play, Sparkles, QrCode, MessageSquare, TrendingUp, X } from 'lucide-react'
                ...
                <div className="rounded-lg border bg-card p-6 shadow-sm">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="rounded-lg bg-primary/10 p-3 text-sm">
                      &ldquo;Check our size chart - these run true to size. Would you like me to help you find the perfect fit?&rdquo;
                    </div>
                    <div className="rounded-lg bg-accent p-3 text-sm">
                      &ldquo;How much is shipping?&rdquo;
                    </div>
                    <div className="rounded-lg bg-primary/10 p-3 text-sm">
                      &ldquo;Free shipping on orders over $50! Your order qualifies ✨&rdquo;
                    </div>
                  </div>
                </div>
              </div>
