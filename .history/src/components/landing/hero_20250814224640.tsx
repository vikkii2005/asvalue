...
export default function Hero() {
  ...
  return (
    <section className='relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pb-16 pt-20 md:pb-20 md:pt-32'>
      ...
      <div className='relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='mx-auto max-w-4xl text-center'>
          {/* Engaging Badge - No Beta */}
          <div className='mb-8 inline-flex items-center rounded-full border border-blue-200 dark:border-blue-500/30 bg-blue-50/50 dark:bg-blue-900/30 px-6 py-2 text-sm shadow-sm backdrop-blur-sm'>
          ...
          <div className='mb-10 flex flex-wrap justify-center gap-8 text-sm text-gray-600 dark:text-gray-400'>
            <div className='flex items-center bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-sm border border-gray-100 dark:border-gray-700'>
              ...
              <span className='font-medium text-gray-700 dark:text-gray-300'>3x More Sales</span>
            </div>
            <div className='flex items-center bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-sm border border-gray-100 dark:border-gray-700'>
              <MessageSquare className='mr-2 h-4 w-4 text-blue-500' />
              <span className='font-medium text-gray-700 dark:text-gray-300'>24/7 AI Support</span>
            </div>
            <div className='flex items-center bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-sm border border-gray-100 dark:border-gray-700'>
              <QrCode className='mr-2 h-4 w-4 text-purple-500' />
              <span className='font-medium text-gray-700 dark:text-gray-300'>Instant Setup</span>
            </div>
          </div>
        ...
        <div className='mx-auto mt-16 max-w-6xl'>
          <div className='relative rounded-2xl bg-gradient-to-tr from-blue-100/50 to-indigo-100/50 dark:from-blue-900/20 dark:to-indigo-900/20 p-4 shadow-2xl backdrop-blur-sm border border-gray-200 dark:border-gray-700'>
