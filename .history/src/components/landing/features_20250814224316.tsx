    ...
    <section id='features' className='bg-gray-50 dark:bg-gray-900 py-20 transition-colors'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mx-auto max-w-4xl text-center'>
          <div className='mb-6 inline-flex items-center rounded-full bg-blue-100 dark:bg-blue-900/30 px-6 py-2 text-sm font-medium text-blue-800 dark:text-blue-300'>
        ...
        <div className='mt-24 text-center'>
          <div className='mx-auto max-w-4xl rounded-3xl border border-blue-200 dark:border-blue-500/30 bg-gradient-to-r from-blue-50 via-white to-indigo-50 dark:from-blue-900/20 dark:via-gray-800 dark:to-indigo-900/20 p-8 md:p-12 shadow-2xl'>
            {/* Urgency Badge */}
            <div className='mb-6 inline-flex items-center rounded-full bg-red-100 dark:bg-red-900/30 px-4 py-2 text-sm font-medium text-red-800 dark:text-red-300'>
              <div className='mr-2 h-2 w-2 animate-pulse rounded-full bg-red-500' />
              Limited Beta Access - Only 20 Spots Left
            </div>
            ...
            <p className='mt-6 text-sm text-gray-500 dark:text-gray-400'>
              🔒 <span className='font-medium'>100% Free During Beta</span> • 
              ⚡ <span className='font-medium'>Instant Access</span> • 
              🚀 <span className='font-medium'>No Credit Card Required</span>
            </p>

            {/* Urgency Footer */}
            <div className='mt-6 rounded-lg bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-500/30 p-4'>
              <p className='text-sm font-medium text-yellow-800 dark:text-yellow-300'>
                ⚠️ <span className='font-bold'>Beta spots filling fast!</span> Join now before we start charging $97/month
              </p>
            </div>
          </div>
        </div>
