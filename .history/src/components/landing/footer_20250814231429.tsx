  ...
  return (
    <footer className='bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white border-t border-gray-200 dark:border-gray-800'>
      <div className='mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8'>
          ...
          <div>
            ...
            <ul className='space-y-3'>
              <li>
                <Link
                  href='#features'
                  className='text-sm text-gray-600 dark:text-gray-300 transition-colors hover:text-gray-900 dark:hover:text-blue-300'
                >
                  Features
                </Link>
              </li>
        ...
        {/* Legal Links */}
        <div className='mt-12 flex flex-wrap justify-center gap-6 border-t border-gray-200 dark:border-gray-800 pt-8'>
          <Link
            href='/privacy'
            className='text-sm text-gray-600 dark:text-gray-300 transition-colors hover:text-gray-900 dark:hover:text-blue-300'
          >
