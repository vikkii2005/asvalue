...
export default function Hero() {
  ...
  return (
    <section className='relative overflow-hidden bg-gray-50 dark:bg-gray-900 pb-16 pt-20 md:pb-20 md:pt-32'>
      ...
      <div className='absolute -right-40 -top-40 h-80 w-80 rounded-full bg-blue-600/5 dark:bg-blue-400/3 blur-3xl' />
      <div className='absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-purple-600/5 dark:bg-purple-400/3 blur-3xl' />

      <div className='relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='mx-auto max-w-4xl text-center'>
          {/* Engaging Badge */}
          <div className='mb-8 inline-flex items-center rounded-full border border-blue-200 dark:border-blue-500/20 bg-blue-50 dark:bg-blue-500/10 px-6 py-2 text-sm shadow-sm backdrop-blur-sm'>
          ...
          <div className='mb-10 flex flex-wrap justify-center gap-6 text-sm'>
            <div className='flex items-center bg-white dark:bg-gray-800 px-4 py-3 rounded-full shadow-sm border border-gray-100 dark:border-gray-700'>
          ...
          <div className='mb-8 flex flex-col justify-center gap-4 sm:flex-row'>
            <button
              ...
              disabled={loading}
              className='group inline-flex h-14 items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-8 text-lg font-bold text-white shadow-2xl transition-all hover:-translate-y-1 hover:shadow-3xl disabled:opacity-50'
            >
              {loading ? (
                <>
        ...
        <div className='mx-auto mt-16 max-w-6xl'>
          <div className='relative rounded-2xl bg-gradient-to-tr from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 p-6 shadow-2xl border border-gray-200 dark:border-gray-700'>
            <div className='rounded-xl bg-white dark:bg-gray-800 p-8 shadow-lg border border-gray-100 dark:border-gray-700'>
              <div className='grid gap-8 md:grid-cols-2'>
                {/* Product Card */}
                <div className='rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-6 shadow-sm'>
                  <div className='mb-4 h-32 rounded-lg bg-gradient-to-br from-blue-200 to-indigo-200 dark:from-blue-700 dark:to-indigo-700 flex items-center justify-center'>
                    <div className='h-16 w-16 rounded-lg bg-white/30 dark:bg-white/20 flex items-center justify-center'>
                  ...
                  <div className='flex items-center justify-between mt-3'>
                    ...
                    <span className='text-sm text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-500/20 px-3 py-1 rounded-full'>
                      In Stock
                    </span>
                  </div>
                  <div className='mt-4 flex items-center justify-between bg-blue-50 dark:bg-blue-500/10 p-3 rounded-lg border border-blue-100 dark:border-blue-500/20'>
                    <div>
                ...
                <div className='rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-6 shadow-sm'>
                  ...
                  <div className='space-y-3'>
                    ...
                    <div className='rounded-lg bg-white dark:bg-gray-800 p-3 border-l-4 border-blue-500 shadow-sm'>
                      <div className='flex items-start space-x-2'>
                        <CheckCircle className='h-4 w-4 text-blue-500 mt-0.5 flex-shrink-0' />
                        <div>
                          <p className='text-sm font-medium text-gray-900 dark:text-white'>Sound Quality Focus</p>
                          <p className='text-xs text-gray-600 dark:text-gray-300'>Hi-Res audio, 40mm drivers, studio-grade sound</p>
                        </div>
                      </div>
                    </div>

                    <div className='rounded-lg bg-white dark:bg-gray-800 p-3 border-l-4 border-green-500 shadow-sm'>
                      <div className='flex items-start space-x-2'>
                        <CheckCircle className='h-4 w-4 text-green-500 mt-0.5 flex-shrink-0' />
                        <div>
                          <p className='text-sm font-medium text-gray-900 dark:text-white'>Comfort & Design</p>
                          <p className='text-xs text-gray-600 dark:text-gray-300'>Lightweight, memory foam, 40hr battery life</p>
                        </div>
                      </div>
                    </div>

                    <div className='rounded-lg bg-white dark:bg-gray-800 p-3 border-l-4 border-purple-500 shadow-sm'>
                      <div className='flex items-start space-x-2'>
                        <CheckCircle className='h-4 w-4 text-purple-500 mt-0.5 flex-shrink-0' />
                        <div>
                          <p className='text-sm font-medium text-gray-900 dark:text-white'>Price & Value</p>
                          <p className='text-xs text-gray-600 dark:text-gray-300'>30-day trial, 2-year warranty, free shipping</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  
                  <div className='mt-4 flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 bg-purple-50 dark:bg-purple-500/10 p-2 rounded border border-purple-100 dark:border-purple-500/20'>
