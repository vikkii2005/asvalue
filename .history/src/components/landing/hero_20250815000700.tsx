...
export default function Hero() {
  ...
  // 🚀 INSTANT: Immediate feedback handler
  const handleSignUp = async () => {
    // Show immediate loading state
    console.log('🚀 Sign up clicked - starting redirect...')
        ...
        <div className='mx-auto max-w-4xl text-center'>
          ...
          <div className='mb-8 flex flex-col justify-center gap-4 sm:flex-row'>
            <button
              ...
              disabled={loading}
              className='group inline-flex h-16 items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-10 text-xl font-bold text-white shadow-2xl transition-all hover:-translate-y-1 hover:from-blue-700 hover:to-purple-700 hover:shadow-3xl disabled:opacity-50 min-w-[300px]'
            >
              {loading ? (
                <>
                  <div className='mr-3 h-6 w-6 animate-spin rounded-full border-3 border-white/30 border-t-white'></div>
                  <span className='whitespace-nowrap'>Redirecting to Google...</span>
                </>
              ) : (
                <>
