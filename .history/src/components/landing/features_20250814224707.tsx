...
export default function Features() {
  ...
  const features = [
    {
      ...
      description:
        'Turn any product into a sales machine in 5 minutes. Share magic links anywhere and watch your sales explode with instant QR codes.',
    ...
    },
    {
      ...
      description:
        'Your AI assistant handles every customer question, overcomes objections, and closes deals while you sleep. No more lost sales.',
      color: 'text-blue-500',
    ...
    },
    {
      ...
      description:
        'WhatsApp, Instagram, TikTok, Facebook - drop your magic link anywhere and start making money immediately. One link, infinite possibilities.',
    ...
    },
    {
      ...
      description:
        'Upload photo, set price, done. No complicated setup, no technical skills needed. Your profit machine is ready before your coffee gets cold.',
    ...
    },
    {
      ...
      description:
        'Real-time dashboard shows exactly which products are printing money. Track every click, conversation, and sale as it happens.',
      color: 'text-red-500',
    ...
    },
    {
      ...
      description:
        'Your AI works 24/7/365. Customers buy at 3AM, AI handles everything. Wake up to sales notifications and growing bank account.',
  ...
  return (
    <section id='features' className='bg-gray-50 dark:bg-gray-900 py-20 transition-colors'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        {/* Enhanced Header */}
        <div className='mx-auto max-w-4xl text-center'>
          <div className='mb-6 inline-flex items-center rounded-full bg-blue-100 dark:bg-blue-900/30 px-6 py-2 text-sm font-medium text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-500/30'>
        ...
        <div className='mt-20 grid gap-8 md:grid-cols-2 lg:grid-cols-3'>
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`group rounded-2xl border ${feature.borderColor} bg-white dark:bg-gray-800 p-8 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl dark:hover:shadow-blue-500/10`}
              >
                {/* Icon and Results Badge */}
                <div className='mb-6 flex items-center justify-between'>
                  ...
                  <span className='rounded-full bg-gray-100 dark:bg-gray-700 px-3 py-1 text-xs font-medium text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-600'>
                    {feature.results}
                  </span>
                </div>
        ...
        {/* Ultra-Compelling CTA Section - No Beta Language */}
        <div className='mt-24 text-center'>
          <div className='mx-auto max-w-4xl rounded-3xl border border-blue-200 dark:border-blue-500/30 bg-gradient-to-r from-blue-50 via-white to-indigo-50 dark:from-blue-900/20 dark:via-gray-800 dark:to-indigo-900/20 p-8 md:p-12 shadow-2xl'>
            {/* Urgency Badge - No Beta */}
            <div className='mb-6 inline-flex items-center rounded-full bg-green-100 dark:bg-green-900/30 px-4 py-2 text-sm font-medium text-green-800 dark:text-green-300 border border-green-200 dark:border-green-500/30'>
            ...
            {/* Benefit-Focused Subheader - No Beta Language */}
            ...
            {/* Risk Reversal - No Beta Language */}
            ...
            {/* Urgency Footer - No Beta Language */}
            <div className='mt-6 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-500/30 p-4'>
